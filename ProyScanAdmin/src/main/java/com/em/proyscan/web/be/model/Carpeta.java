package com.em.proyscan.web.be.model;
...
public class Carpeta {
    ...
    private List<String> lstScanedImages;
    private String fileNameFP;
    private String urlFileNameFP;
    ...
    public String getCarpetaOID() {
        return carpetaOID;
    }

    public void setCarpetaOID(String carpetaOID) {
        this.carpetaOID = carpetaOID;
    }

    public List<String> getLstScanedImages() {
        return lstScanedImages;
    }

    public void setLstScanedImages(List<String> lstScanedImages) {
        this.lstScanedImages = lstScanedImages;
    }
	...
	public String getUrlFileNameFP() {
		return urlFileNameFP;
	}

	public void setUrlFileNameFP(String urlFileNameFP) {
		this.urlFileNameFP = urlFileNameFP;
	}
